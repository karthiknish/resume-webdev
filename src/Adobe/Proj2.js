...
import wireframe from "../assets/Xd-2-wireframe.PNG";
import website from "../assets/Xd-2-main.PNG";
        ...
        >
          ...
          >
            <div style={{ margin: "30px" }}>
              <h1 style={{ color: "#E6FE0E" }}>Travel Page Prototype</h1>
              <p style={{ color: "white", fontWeight: "200" }}>
                Explore Indonesia inspired travel page
              </p>
              <div>
                <a
                  rel="noopener noreferrer"
                  href="https://drive.google.com/file/d/1IBrlcJhV56PiMBe3Y4_UTzD175_p35kx/view?usp=sharing"
                  target="_blank"
                  className="view"
                >
                  view project
