  ...
  componentDidMount() {
    client
      .getEntries({
        ...
        "fields.slug[match]": this.props.match.params.project,
      })
      .then((entry) => {
        entry.total === 1
          ...
          {project.fields && !this.state.notFound && (
            <article className="single-project site-cont">
              ...
              <div className="meta">
                ...
                <Markdown
                  options={{ overrides: { img: { component: hideImg } } }}
                >
              ...
              <div className="article-content">
                <Markdown
                  options={{ overrides: { p: { component: showImg } } }}
                >
                  {project.fields.content}
                </Markdown>
              </div>
          ...
          {this.state.notFound && (
            <article className="single-project site-cont">
              <div className="meta">
                ...
                <p>
                  The project you are looking for couldn't be found. You can{" "}
                  <Link to="/projects">view all of our projects here</Link>, or{" "}
                  <Link to="/">go back to the homepage here instead.</Link>
                </p>
              </div>
            </article>
          )}
